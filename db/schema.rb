...
ActiveRecord::Schema[8.0].define(version: 2017_03_10_151236) do
  ...
  create_table "access_tokens", force: :cascade do |t|
    ...
    t.index ["operator_id"], name: "index_access_tokens_on_operator_id"
    t.index ["token"], name: "index_access_tokens_on_token", unique: true
    t.index ["vendor_id"], name: "index_access_tokens_on_vendor_id"
  end
  ...
  create_table "acme_authorize_domains", force: :cascade do |t|
    ...
    t.integer "vendor_id"
    t.index ["domain", "token"], name: "index_acme_authorize_domains_on_domain_and_token"
    t.index ["domain"], name: "index_acme_authorize_domains_on_domain"
  end
  ...
  create_table "asset_images", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["vendor_id"], name: "index_asset_images_on_vendor_id"
  end
  ...
  create_table "blog_posts", force: :cascade do |t|
    ...
    t.index ["vendor_id"], name: "index_blog_posts_on_vendor_id"
  end
  ...
  create_table "branch_categories", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["CategoryId", "CategoryGroup", "title"], name: "branch_categories_index", unique: true
  end
  ...
  create_table "cart_items", force: :cascade do |t|
    ...
    t.index ["cart_id", "good_type", "good_id"], name: "index_cart_items_on_cart_id_and_good_type_and_good_id", unique: true
  ...
  create_table "carts", force: :cascade do |t|
    ...
    t.index ["vendor_id", "session_id"], name: "index_carts_on_vendor_id_and_session_id", unique: true
    t.index ["vendor_id"], name: "index_carts_on_vendor_id"
  end
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.index ["deep_published_products_count"], name: "index_categories_on_deep_published_products_count"
    t.index ["vendor_id", "cached_default_slug"], name: "index_categories_on_vendor_id_and_cached_default_slug"
    t.index ["vendor_id", "externalcode"], name: "index_categories_on_vendor_id_and_externalcode", unique: true
    t.index ["vendor_id", "ms_uuid"], name: "index_categories_on_vendor_id_and_ms_uuid", unique: true
    t.index ["vendor_id", "published_products_count"], name: "index_categories_on_vendor_id_and_published_products_count"
    t.index ["vendor_id", "vk_album_id"], name: "index_categories_on_vendor_id_and_vk_album_id", unique: true
  ...
  create_table "categories_coupons", id: false, force: :cascade do |t|
    ...
    t.integer "coupon_id"
    t.index ["category_id"], name: "index_categories_coupons_on_category_id"
    t.index ["coupon_id"], name: "index_categories_coupons_on_coupon_id"
  end
  ...
  create_table "client_emails", force: :cascade do |t|
    ...
    t.index ["email", "client_id"], name: "index_client_emails_on_email_and_client_id", unique: true
  end
  ...
  create_table "client_phones", force: :cascade do |t|
    ...
    t.index ["phone", "client_id"], name: "index_client_phones_on_phone_and_client_id", unique: true
  end
  ...
  create_table "clients", force: :cascade do |t|
    ...
    t.index ["vendor_id"], name: "index_clients_on_vendor_id"
  end
  ...
  create_table "content_pages", force: :cascade do |t|
    ...
    t.hstore "title_translations"
    t.hstore "content_translations"
    t.index ["vendor_id", "cached_default_slug"], name: "index_content_pages_on_vendor_id_and_cached_default_slug"
    t.index ["vendor_id", "position"], name: "index_content_pages_on_vendor_id_and_position"
    t.index ["vendor_id"], name: "index_content_pages_on_vendor_id"
  end
  ...
  create_table "coupons", force: :cascade do |t|
    ...
    t.index ["code", "vendor_id"], name: "index_coupons_on_code_and_vendor_id", unique: true
  end
  ...
  create_table "dictionaries", force: :cascade do |t|
    ...
    t.hstore "custom_title_translations"
    t.hstore "cached_title_translations"
    t.index ["vendor_id", "cached_default_slug"], name: "index_dictionaries_on_vendor_id_and_cached_default_slug"
    t.index ["vendor_id", "externalcode"], name: "index_dictionaries_on_vendor_id_and_externalcode", unique: true
    t.index ["vendor_id", "key"], name: "index_dictionaries_on_vendor_id_and_key", unique: true
    t.index ["vendor_id", "ms_uuid"], name: "index_dictionaries_on_vendor_id_and_ms_uuid", unique: true
    t.index ["vendor_id", "stock_title"], name: "index_dictionaries_on_vendor_id_and_stock_title"
  end
  ...
  create_table "dictionary_entities", force: :cascade do |t|
    ...
    t.hstore "description_translations"
    t.integer "next_resource_id"
    t.index ["dictionary_id"], name: "index_dictionary_entities_on_dictionary_id"
    t.index ["products_count"], name: "index_dictionary_entities_on_products_count"
    t.index ["published_products_count"], name: "index_dictionary_entities_on_published_products_count"
    t.index ["vendor_id", "cached_default_slug"], name: "index_dictionary_entities_on_vendor_id_and_cached_default_slug"
    t.index ["vendor_id", "externalcode"], name: "index_dictionary_entities_on_vendor_id_and_externalcode", unique: true
    t.index ["vendor_id", "ms_uuid"], name: "index_dictionary_entities_on_vendor_id_and_ms_uuid", unique: true
    t.index ["vendor_id", "stock_title"], name: "index_dictionary_entities_on_vendor_id_and_stock_title"
    t.index ["vendor_id"], name: "index_dictionary_entities_on_vendor_id"
  end
  ...
  create_table "domain_aliases", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["domain"], name: "index_domain_aliases_on_domain", unique: true
    t.index ["vendor_id"], name: "index_domain_aliases_on_vendor_id"
  end
  ...
  create_table "history_paths", force: :cascade do |t|
    ...
    t.index ["vendor_id", "path"], name: "index_history_paths_on_vendor_id_and_path", unique: true
    t.index ["vendor_id", "response_state"], name: "index_history_paths_on_vendor_id_and_response_state"
    t.index ["vendor_id", "state", "content_type"], name: "index_history_paths_on_vendor_id_and_state_and_content_type"
    t.index ["vendor_id", "state", "updated_at"], name: "index_history_paths_on_vendor_id_and_state_and_updated_at"
  end
  ...
  create_table "import_spread_sheet_infos", force: :cascade do |t|
    ...
    t.index ["vendor_id"], name: "index_import_spread_sheet_infos_on_vendor_id"
  end
  ...
  create_table "invites", force: :cascade do |t|
    ...
    t.integer "role_id"
    t.index ["email", "vendor_id"], name: "index_invites_on_email_and_vendor_id", unique: true
    t.index ["key"], name: "index_invites_on_key", unique: true
    t.index ["vendor_id", "phone"], name: "index_invites_on_vendor_id_and_phone", unique: true
  end
  ...
  create_table "lookbooks", force: :cascade do |t|
    ...
    t.index ["vendor_id", "cached_default_slug"], name: "index_lookbooks_on_vendor_id_and_cached_default_slug"
    t.index ["vendor_id"], name: "index_lookbooks_on_vendor_id"
  end
  ...
  create_table "mail_templates", force: :cascade do |t|
    ...
    t.index ["vendor_id", "namespace", "key"], name: "index_mail_templates_on_vendor_id_and_namespace_and_key", unique: true
    t.index ["vendor_id"], name: "index_mail_templates_on_vendor_id"
  end
  ...
  create_table "members", force: :cascade do |t|
    ...
    t.integer "role_id"
    t.index ["operator_id", "vendor_id"], name: "index_members_on_operator_id_and_vendor_id", unique: true
    t.index ["operator_id"], name: "index_members_on_operator_id"
    t.index ["vendor_id"], name: "index_members_on_vendor_id"
  end
  ...
  create_table "menu_items", force: :cascade do |t|
    ...
    t.datetime "deleted_at"
    t.hstore "custom_title_translations"
    t.index ["vendor_id", "place", "position"], name: "index_menu_items_on_vendor_id_and_place_and_position"
  end
  ...
  create_table "openbill_webhook_logs", id: :uuid, default: -> { "uuid_generate_v4()" }, force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.index ["level"], name: "openbill_webhook_logs_on_level"
    t.index ["transaction_id"], name: "openbill_webhook_logs_on_transaction_id"
  end
  ...
  create_table "operators", force: :cascade do |t|
    ...
    t.index ["last_logout_at", "last_activity_at"], name: "index_operators_on_last_logout_at_and_last_activity_at"
    t.index ["phone"], name: "index_operators_on_phone", unique: true
    t.index ["remember_me_token"], name: "index_operators_on_remember_me_token"
    t.index ["reset_password_token"], name: "index_operators_on_reset_password_token"
  ...
  create_table "order_condition_orders", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["order_condition_id"], name: "index_order_condition_orders_on_order_condition_id"
    t.index ["order_id"], name: "index_order_condition_orders_on_order_id"
  end
  ...
  create_table "order_conditions", force: :cascade do |t|
    ...
    t.index ["enter_workflow_state_id"], name: "index_order_conditions_on_enter_workflow_state_id"
    t.index ["vendor_delivery_id"], name: "index_order_conditions_on_vendor_delivery_id"
    t.index ["vendor_id", "vendor_delivery_id", "vendor_payment_id", "enter_workflow_state_id", "event", "enter_finite_state"], name: "order_conditions_index"
    t.index ["vendor_id"], name: "index_order_conditions_on_vendor_id"
    t.index ["vendor_payment_id"], name: "index_order_conditions_on_vendor_payment_id"
  end
  ...
  create_table "order_local_stocks", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["order_id"], name: "index_order_local_stocks_on_order_id"
  end
  ...
  create_table "order_log_entities", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["order_id", "id"], name: "index_order_log_entities_on_order_id_and_id"
  end
  ...
  create_table "order_operator_filters", force: :cascade do |t|
    ...
    t.integer "coupon_id"
    t.index ["vendor_id"], name: "index_order_operator_filters_on_vendor_id"
  end
  ...
  create_table "order_remote_stocks", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["order_id"], name: "index_order_remote_stocks_on_order_id"
  end
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.index ["vendor_id", "coupon_code"], name: "index_orders_on_vendor_id_and_coupon_code"
    t.index ["vendor_id", "will_cancel_at"], name: "index_orders_on_vendor_id_and_will_cancel_at"
    t.index ["vendor_id", "workflow_state_id"], name: "index_orders_on_vendor_id_and_workflow_state_id"
  end
  ...
  create_table "partner_coupons", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["code"], name: "index_partner_coupons_on_code", unique: true
    t.index ["partner_id"], name: "index_partner_coupons_on_partner_id"
  end
  ...
  create_table "payment_accounts", force: :cascade do |t|
    ...
    t.index ["token"], name: "index_payment_accounts_on_token", unique: true
    t.index ["vendor_id"], name: "index_payment_accounts_on_vendor_id"
  end
  ...
  create_table "payment_to_deliveries", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["vendor_delivery_id"], name: "index_payment_to_deliveries_on_vendor_delivery_id"
    t.index ["vendor_payment_id", "vendor_delivery_id"], name: "payment_to_deliveries_uniqueness", unique: true
    t.index ["vendor_payment_id"], name: "index_payment_to_deliveries_on_vendor_payment_id"
  end
  ...
  create_table "phone_confirmations", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["operator_id", "phone"], name: "index_phone_confirmations_on_operator_id_and_phone", unique: true
    t.index ["operator_id"], name: "index_phone_confirmations_on_operator_id"
  end
  ...
  create_table "product_images", force: :cascade do |t|
    ...
    t.index ["product_id", "is_main", "id"], name: "index_product_images_on_product_id_and_is_main_and_id", order: { is_main: :desc, id: :desc }
  ...
  create_table "product_items", force: :cascade do |t|
    ...
    t.hstore "custom_title_translations"
    t.hstore "cached_title_translations"
    t.index ["product_id", "externalcode"], name: "index_product_items_on_product_id_and_externalcode", unique: true
    t.index ["product_id"], name: "index_product_items_on_product_id"
    t.index ["product_id"], name: "product_id_and_deleted_at", where: "(deleted_at IS NULL)"
    t.index ["vendor_id", "article"], name: "index_product_items_on_vendor_id_and_article"
    t.index ["vendor_id", "ms_consignment_uuid"], name: "index_product_items_on_vendor_id_and_ms_consignment_uuid", unique: true
    t.index ["vendor_id", "ms_uuid"], name: "index_product_items_on_vendor_id_and_ms_uuid", unique: true
    t.index ["vendor_id", "quantity_synced_at"], name: "index_product_items_on_vendor_id_and_quantity_synced_at"
    t.index ["vendor_id", "stock_synced_at"], name: "index_product_items_on_vendor_id_and_stock_synced_at"
  end
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.index ["categories_ids"], name: "index_products_on_categories_ids", using: :gin
    t.index ["category_positions"], name: "index_products_on_category_positions", using: :gin
    t.index ["dictionary_entity_ids"], name: "index_products_on_dictionary_entity_ids", using: :gin
    t.index ["has_ordering_goods"], name: "index_products_on_has_ordering_goods"
    t.index ["product_union_id"], name: "index_products_on_product_union_id"
    t.index ["vendor_id", "article"], name: "index_products_on_vendor_id_and_article"
    t.index ["vendor_id", "cached_default_slug"], name: "index_products_on_vendor_id_and_cached_default_slug"
    t.index ["vendor_id", "deleted_at"], name: "index_products_on_vendor_id_and_deleted_at"
    t.index ["vendor_id", "externalcode"], name: "index_products_on_vendor_id_and_externalcode", unique: true
    t.index ["vendor_id", "is_published", "product_union_id"], name: "index_published_products", where: "(deleted_at IS NULL)"
    t.index ["vendor_id", "ms_consignment_uuid"], name: "index_products_on_vendor_id_and_ms_consignment_uuid", unique: true
    t.index ["vendor_id", "ms_uuid"], name: "index_products_on_vendor_id_and_ms_uuid", unique: true
    t.index ["vendor_id", "quantity_synced_at"], name: "index_products_on_vendor_id_and_quantity_synced_at"
    t.index ["vendor_id", "type"], name: "index_products_on_vendor_id_and_type"
  end
  ...
  create_table "role_permissions", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["resource_type", "role_id"], name: "index_role_permissions_on_resource_type_and_role_id", unique: true
  ...
  create_table "roles", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["vendor_id", "key"], name: "index_roles_on_vendor_id_and_key", unique: true
  end
  ...
  create_table "slider_images", force: :cascade do |t|
    ...
    t.index ["vendor_id", "is_active", "position"], name: "index_slider_images_on_vendor_id_and_is_active_and_position"
    t.index ["vendor_id"], name: "index_slider_images_on_vendor_id"
  end
  ...
  create_table "slugs", force: :cascade do |t|
    ...
    t.index ["resource_type", "resource_id"], name: "index_slugs_on_resource_type_and_resource_id"
    t.index ["vendor_id", "path"], name: "index_slugs_on_vendor_id_and_path", unique: true
    t.index ["vendor_id", "redirect_path"], name: "index_slugs_on_vendor_id_and_redirect_path"
    t.index ["vendor_id", "resource_id", "resource_type"], name: "index_slugs_on_vendor_id_and_resource_id_and_resource_type", unique: true, where: "((type)::text = 'SlugResource'::text)"
    t.index ["vendor_id", "type"], name: "index_slugs_on_vendor_id_and_type"
    t.index ["vendor_id"], name: "index_slugs_on_vendor_id"
  end
  ...
  create_table "stock_importing_log_entities", force: :cascade do |t|
    ...
    t.index ["vendor_id", "created_at"], name: "index_stock_importing_log_entities_on_vendor_id_and_created_at"
    t.index ["vendor_id"], name: "index_stock_importing_log_entities_on_vendor_id"
  end
  ...
  create_table "subscription_emails", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["vendor_id", "email"], name: "index_subscription_emails_on_vendor_id_and_email", unique: true
  end
  ...
  create_table "system_mail_recipients", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["system_mail_delivery_id", "vendor_id", "operator_id"], name: "unique_system_mail_delivery_entity", unique: true
  end
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["vendor_id"], name: "index_tags_on_vendor_id"
  end
  ...
  create_table "tariff_orders", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["tariff_id"], name: "index_tariff_orders_on_tariff_id"
  end
  ...
  create_table "text_blocks", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["product_id", "position"], name: "index_text_blocks_on_product_id_and_position"
    t.index ["product_id"], name: "index_text_blocks_on_product_id"
  end
  ...
  create_table "top_banners", force: :cascade do |t|
    ...
    t.datetime "updated_at"
    t.hstore "content_translations"
    t.index ["vendor_id"], name: "index_top_banners_on_vendor_id"
  end
  ...
  create_table "translations", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["vendor_id", "locale", "key"], name: "index_translations_on_vendor_id_and_locale_and_key"
  end
  ...
  create_table "vendor_amo_crms", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["vendor_id"], name: "index_vendor_amo_crms_on_vendor_id"
  end
  ...
  create_table "vendor_analytics_days", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["vendor_id", "date"], name: "index_vendor_analytics_days_on_vendor_id_and_date", unique: true
    t.index ["vendor_id"], name: "index_vendor_analytics_days_on_vendor_id"
  end
  ...
  create_table "vendor_deliveries", force: :cascade do |t|
    ...
    t.index ["vendor_id", "position", "is_active"], name: "index_vendor_deliveries_on_vendor_id_and_position_and_is_active"
    t.index ["vendor_id"], name: "index_vendor_deliveries_on_vendor_id"
  end
  ...
  create_table "vendor_jobs", force: :cascade do |t|
    ...
    t.index ["vendor_id", "state"], name: "index_vendor_jobs_on_vendor_id_and_state"
    t.index ["vendor_id"], name: "index_vendor_jobs_on_vendor_id"
  end
  ...
  create_table "vendor_payments", force: :cascade do |t|
    ...
    t.index ["vendor_id", "position", "is_active"], name: "index_vendor_payments_on_vendor_id_and_position_and_is_active"
  ...
  create_table "vendor_product_analytics_days", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["product_id"], name: "index_vendor_product_analytics_days_on_product_id"
    t.index ["vendor_id", "date", "product_id"], name: "vpad_uniq", unique: true
    t.index ["vendor_id"], name: "index_vendor_product_analytics_days_on_vendor_id"
  end
  ...
  create_table "vendor_properties", force: :cascade do |t|
    ...
    t.hstore "custom_title_translations"
    t.hstore "cached_title_translations"
    t.index ["vendor_id", "externalcode"], name: "index_vendor_properties_on_vendor_id_and_externalcode", unique: true
    t.index ["vendor_id", "is_used_in_item"], name: "index_vendor_properties_on_vendor_id_and_is_used_in_item"
    t.index ["vendor_id", "is_used_in_product"], name: "index_vendor_properties_on_vendor_id_and_is_used_in_product"
    t.index ["vendor_id", "key"], name: "index_vendor_properties_on_vendor_id_and_key", unique: true
    t.index ["vendor_id", "ms_uuid"], name: "index_vendor_properties_on_vendor_id_and_ms_uuid", unique: true
    t.index ["vendor_id", "stock_title"], name: "index_vendor_properties_on_vendor_id_and_stock_title"
  end
  ...
  create_table "vendor_selling_currencies", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["vendor_id", "currency_iso_code"], name: "vendor_currencies", unique: true
  end
  ...
  create_table "vendor_sessions", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["vendor_id", "session_id"], name: "index_vendor_sessions_on_vendor_id_and_session_id", unique: true
  end
  ...
  create_table "vendor_sms_log_entities", force: :cascade do |t|
    ...
    t.index ["vendor_id"], name: "index_vendor_sms_log_entities_on_vendor_id"
  end
  ...
  create_table "vendor_themes", force: :cascade do |t|
    ...
    t.index ["vendor_id"], name: "index_vendor_themes_on_vendor_id"
  end
  ...
  create_table "vendor_walletones", force: :cascade do |t|
    ...
    t.index ["vendor_id"], name: "index_vendor_walletones_on_vendor_id"
  end
  ...
  create_table "vendors", force: :cascade do |t|
    ...
    t.bigint "total_file_size", default: 0
    t.bigint "total_orders_price_kopeks", default: 0, null: false
    t.string "total_orders_price_currency", limit: 255, default: "RUB", null: false
    t.bigint "total_success_orders_price_kopeks", default: 0, null: false
    ...
    t.index ["cached_home_url"], name: "index_vendors_on_cached_home_url", unique: true
    t.index ["clients_count"], name: "index_vendors_on_clients_count"
    t.index ["domain"], name: "index_vendors_on_domain", unique: true
    t.index ["key"], name: "index_vendors_on_key", unique: true
    t.index ["manager_id"], name: "index_vendors_on_manager_id"
    t.index ["subdomain"], name: "index_vendors_on_subdomain", unique: true
  end
  ...
  create_table "wishlist_items", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["wishlist_id", "good_global_id"], name: "index_wishlist_items_on_wishlist_id_and_good_global_id", unique: true
  ...
  create_table "wishlists", force: :cascade do |t|
    ...
    t.index ["vendor_id", "client_id"], name: "index_wishlists_on_vendor_id_and_client_id", unique: true
    t.index ["vendor_id", "slug"], name: "index_wishlists_on_vendor_id_and_slug", unique: true
    t.index ["vendor_id"], name: "index_wishlists_on_vendor_id"
  end
  ...
  create_table "workflow_states", force: :cascade do |t|
    ...
    t.integer "orders_count", default: 0, null: false
    t.index ["vendor_id", "finite_state"], name: "index_workflow_states_on_vendor_id_and_finite_state"
    t.index ["vendor_id", "name"], name: "index_workflow_states_on_vendor_id_and_name"
    t.index ["vendor_id"], name: "index_workflow_states_on_vendor_id"
  end
